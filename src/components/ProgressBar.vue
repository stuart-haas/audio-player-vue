<template>
  <div
    ...
    class="relative"
  >
    <div class="absolute text-white transform top-full left-0 mt-2 tracking-widest bg-slate-900 bg-opacity-75 rounded-lg px-2 leading-none pt-0.5 select-none">{{ currentTimeToReadable }}</div>
    ...
    <div class="absolute text-white transform top-full right-0 mt-2 tracking-widest bg-slate-900 bg-opacity-75 rounded-lg px-2 leading-none pt-0.5 select-none">{{ remainingTimeToReadable }}</div>
  </div>
</template>
